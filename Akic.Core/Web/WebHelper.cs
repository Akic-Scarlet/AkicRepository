...
namespace Akic.Core.Web
{
    public class WebHelper
    {
        ...
        /// <param name="isUpper">isUpper</param>
        ...
        public static void WriteCookie(string strName, string strValue)
        {
            ...
            string test = HttpContext.Current.Request.Cookies["strName"].Value;
        }
        /// <summary>
        /// 写cookie值
        /// </summary>
        ...
        {
            string a = HttpContext.Current.Request.Cookies.ToString();
            string b = HttpContext.Current.Request.Cookies[strName].ToString();
