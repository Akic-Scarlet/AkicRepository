...
namespace Akic.FrameWorkEx.Areas.Admin.Controllers
{
    public class BlogPostController : Controller
    {
          ...
          public BlogPostController(IArticleService ArticleServer)
        {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public JsonResult Create(Article model)
        {
            ...
            if (model != null)
            {
                ...
                _articleServer.Insert(model);
                LogRecord.WriteServiceLog("admin", "admin添加成功" + model.ArticleTitle + "博客", "warnning");
