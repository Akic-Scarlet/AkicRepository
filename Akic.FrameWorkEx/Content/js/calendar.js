        ...
        var calendar = function (calendarId) {
            ...
            c.getcalendar = function (year, month) {
                ...
                for (var g = 0; g <= 6; g++) {
                    ...
                    if (g <= lastday) {
                        str += '<td class="TbFont">' + remainlastdate++ + '</td>';
                    } else {
                        //高亮显示当前日期
                        ...
                        if (remainlastday <= Maxdate) {
                            if (thisyear == year && thismonth == month && today == remainlastday) {
                                ...
                                if ((thisyear != year && remainlastday == 1) || (thismonth != month && remainlastday == 1)) {
                                    ...
                                    str += '<td class="TbFont">' + remainlastday++ + '</td>';
                                }
                            }
                        } else {
                            str += '<td class="TbFont">' + nextMonthday++ + '</td>';
                        }
                    }
                    str += '</tr>';
                }
            ...
            c.init = function () {
                ...
                .Tr{color:gray;text-align:center;}\
                .redTr{color:red;text-align:center;}\
              .TbFont{ color:gray;text-align:center;}\
